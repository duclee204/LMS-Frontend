...
@Component({
  selector: 'app-doexam2',
  templateUrl: './doexam2.component.html',
  styleUrls: ['./doexam2.component.scss']
})
export class Doexam2Component implements AfterViewInit {
  ...
  ngAfterViewInit() {
    // Không cần xử lý gì thêm, mọi binding đã dùng Angular
  }
